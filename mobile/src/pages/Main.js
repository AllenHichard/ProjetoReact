...
<Marker coordinate= {{latitude: -27.2111164, longitude: -49.6374491}}>
                <Image style={styles.avatar} source={{uri: "https://avatars3.githubusercontent.com/u/53483318?s=460&v=4"}}/>
                <Callout onPress={()=>{
                    navigation.navigate('Profile', {github_username: 'diego3g'});
                }} >
                    <View style={styles.callout}>
                        <Text style={styles.devName}>aaaaaaaaaaa</Text>
                        <Text style={styles.devBio}>baaaaaaaaaaaaa</Text>
                        <Text style={styles.devTechs}>aaaaaaaaaaaaac</Text>
                    </View>
                </Callout>
            </Marker>
